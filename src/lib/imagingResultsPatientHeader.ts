...
/** Imaging result template patient-information slots (612×792 ref). */
const IMAGING_PATIENT_HEADER_SLOTS = {
  name: { refX: 118, refFromTop: 211, fontSize: 9 },
  dateRequested: { refX: 395, refFromTop: 211, fontSize: 9 },
  patientId: { refX: 376, refFromTop: 272, fontSize: 9 },
...
/** Overlay patient information on imaging result PDF templates. */
export function drawImagingResultsPatientHeader(
  page: PDFPage,
  ...
  const s = IMAGING_PATIENT_HEADER_SLOTS;
